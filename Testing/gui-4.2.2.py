...
def utskrift_vit(tree6, fornavn_vit, etternavn_vit, total_vit):
    ...
    m_total = ('SELECT SUM(Studiepoeng) as TotalStudiepoeng '
            'FROM Eksamensresultat, Emne '
            'WHERE Studentnr = %s '
            'AND Emne.Emnekode = Eksamensresultat.Emnekode '
            'GROUP BY Karakter '
            'ORDER BY TotalStudiepoeng DESC '
            'LIMIT 1')
...
def utskrifter():
    ...
    ttk.Label(f1, text="Alle eksamensresultater i et emne").grid(column=0, columnspan=3, row=0, pady=15, padx=15)
    ...
    ttk.Label(f2, text="Eksamensresultater for en student").grid(column=0, columnspan=3, row=0, pady=15, padx=15)
    ...
    ttk.Label(f4, text='Karakterstatistikk for en eksamen').grid(column=0, columnspan=4, row=0, pady=15, padx=15)
    ...
    ttk.Label(f5, text="En oversikt som viser studentene i et emne").grid(column=0, columnspan=3, row=0, pady=15,
                                                                          padx=15)
    ...
    tree5.column("#1", width=175)
    tree5.column("#2", width=175)
    tree5.column("#3", width=175)
    tree5.column("#4", width=175)
...
def adm_stud_gui():
    ...
    p2 = ttk.Panedwindow(f2, orient=VERTICAL, width=340, height=65)
    p2.grid(row=3, column=3, padx=10, pady=5, sticky=E, rowspan=4, columnspan=3)
    l3 = ttk.Labelframe(p2, text='Info', width=340, height=65)
    p2.add(l3)
...
ttk.Label(mainframe, text="Administrering av eksamen ved HSN", font=100).grid(column=0, row=0, columnspan=3, pady=50)
ttk.Separator(mainframe, orient=HORIZONTAL).grid(column=0, row=1, columnspan=3, sticky=(W, E))

ttk.Label(mainframe, text="Administrer Studenter", font=25).grid(column=0, row=2, sticky=(E, W))
ttk.Button(mainframe, text="Studenter", width=30, command=adm_stud_gui).grid(column=1, row=2, padx=20, sticky=(N, S))

ttk.Label(mainframe, text="Administrer Emner", font=25).grid(column=0, row=3, sticky=(E, W))
ttk.Button(mainframe, text="Emner", width=30, command=adm_emne_gui).grid(column=1, row=3, padx=20, sticky=(N, S))

ttk.Label(mainframe, text="Administrer Rom", font=25).grid(column=0, row=4, sticky=(E, W))
ttk.Button(mainframe, text="Rom", width=30, command=adm_rom_gui).grid(column=1, row=4, padx=20, sticky=(N, S))

ttk.Label(mainframe, text="Administrer Eksamener", font=25).grid(column=0, row=5, sticky=(E, W))
ttk.Button(mainframe, text="Eksamener", width=30, command=adm_eksamen_gui).grid(column=1, row=5, padx=20, sticky=(N, S))

ttk.Label(mainframe, text="Administrer Karakterer", font=25).grid(column=0, row=6, sticky=(E, W))
...
ttk.Label(mainframe, text="Utskrifter av oversikter", font=25).grid(column=0, row=8, sticky=(E, W))
...
tekst4.insert('1.0', '* Legge til eksamner \n'
                     '* Endre eksamner \n'
                     '* Få utskrifter av alle oppsatte eksamner \n'
