...
def adm_eksamen_gui():
    ...
    ttk.Label(adm_eks, text='Administrering av Eksamen', font=('Calibri', '16')).grid(column=0, columnspan=1, row=0, pady=15, padx=15,
                                                              sticky='WE')
    ...
    ttk.Label(f3, text='Emnekode:').grid(row=0, column=0, padx=5, pady=5, sticky=W)
    ttk.Entry(f3, textvariable=emne_kode_opp, width=15).grid(row=0, column=1, padx=5, pady=5, sticky=W)

    ttk.Label(f3, text='Dato:').grid(row=1, column=0, padx=5, pady=5, sticky=W)
    ttk.Entry(f3, textvariable=dato_opp, width=15).grid(row=1, column=1, padx=5, pady=5, sticky=W)

    ttk.Label(f3, text='Studentnr:').grid(row=2, column=0, padx=5, pady=5, sticky=W)
    ttk.Entry(f3, textvariable=studentnr_opp, width=15).grid(row=2, column=1, padx=5, pady=5, sticky=W)
    ...
    ttk.Label(f3, justify='left', text='Oversikt over alle \n oppmeldte elever').grid(row=4, column=2, padx=25,
                                                                                       pady=10, sticky=(N, W))
    ttk.Button(f3, text='Klikk her!', command=lambda: utskrift_opp(tree_opp, emne_kode_opp, dato_opp, studentnr_opp)).grid(row=4, column=2, padx=25,
                                                                                   pady=50, sticky=(N, W))

    # Oppretter Panedwindow for Notebook side 1 og legger inn veiledende tekst
    p1 = ttk.Panedwindow(f3, orient=VERTICAL)
    p1.grid(row=0, column=2, columnspan=3, rowspan=3, padx=20, pady=10)
    l1 = ttk.Labelframe(p1, text='Info', width=150, height=100)
    p1.add(l1)
    ...
    # add tree and scrollbars to frame
    tree_opp.grid(row=4, column=0, columnspan=2, pady=7, sticky=NSEW)
    ysb.grid(row=4, column=2, pady=7, sticky=(N, S, W))
