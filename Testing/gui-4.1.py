...
def adm_eksamen_gui():
    ...
    # Side 2 i notebook
    # Lager et boks som gir informasjon til brukeren om hva han skal gjøre
    ...
    #Lager labels og entries for emnekode, dato og romnr
    ...
    # Knapp for å utføre handlingen
    ttk.Button(f2, text='Endre eksamen', command=eksamen_endre).grid(row=7, column=2, padx=5, pady=5, sticky=W)
