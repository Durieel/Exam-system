...
def utskrift_eksamen_pd(fra_aar_utskriftside3, fra_m_utskriftside3, fra_d_utskriftside3, til_aar_utskriftside3, til_m_utskriftside3,
                        til_d_utskriftside3, tree3):
    # Binder Treeviewet
    tree3.bind()
...
def utskrifter():
    ...
    # Labels og entries for side 4
    # Lager et panewindow som skal gi informasjon til brukeren
    ttk.Label(f5, text="En oversikt som viser studentene i et emne", font=('Calibri', '14'))\
...
def adm_eksamen_gui():
    ...
    ttk.Entry(f3, textvariable=emnekode_eksamenoppmelding, width=15)\
        .grid(row=1, column=1, rowspan=3, padx=5, pady=5, sticky=N)

    ttk.Label(f3, text='Dato:').grid(row=1, column=0, rowspan=3, padx=5, pady=35, sticky=(N, W))
    dato_aar_eksamenoppmelding = StringVar()
    ttk.Entry(f3, textvariable=dato_aar_eksamenoppmelding, width=5).grid(column=1, row=1, rowspan=3, padx=80, pady=35,
                                                                         sticky=(N, W))
    dato_m_eksamenoppmelding = StringVar()
    ttk.Entry(f3, textvariable=dato_m_eksamenoppmelding, width=3).grid(column=1, row=1, rowspan=3, padx=45, pady=35,
                                                                       sticky=(N, W))
    dato_d_eksamenoppmelding = StringVar()
    ttk.Entry(f3, textvariable=dato_d_eksamenoppmelding, width=3).grid(column=1, row=1, rowspan=3, padx=10, pady=35,
                                                                       sticky=(N, W))
    ...
    ttk.Entry(f3, textvariable=studentnr_eksamenoppmelding, width=15)\
        .grid(row=1, column=1, rowspan=3, padx=5, pady=65, sticky=N)
