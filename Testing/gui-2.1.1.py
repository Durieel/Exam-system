...
def utskrift_eksamen(fra_dag, fra_maaned, fra_aar, til_dag, til_maaned, til_aar, tree3):
    tree3.bind()
    # Oppretter en cursor
    marker = mydb.cursor()
...
def utskrifter():
    ...
    ttk.Button(f3, text='Utfør', command=lambda: utskrift_eksamen(fra_dag, fra_maaned, fra_aar, til_dag, til_maaned,
...
def adm_eksamen_gui():
    ...
    ttk.Label(f1, justify='left', text='Oversikt over alle \n oppsatte eksamner').grid(row=4, column=2, padx=25,
                                                                                       pady=10, sticky=(N, W))
    ttk.Button(f1, text='Oppsatte eksamener', command=lambda: utskrift_eksamen(tree)).grid(row=4, column=2, padx=25,
                                                                                           pady=50, sticky=(N, W))
