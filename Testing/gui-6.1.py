...
def utskrift_eksamen_pd(fra_d_utskriftside3, fra_m_utskriftside3, fra_aar_utskriftside3, til_d_utskriftside3,
                        til_m_utskriftside3, til_aar_utskriftside3, tree3):
    # Binder Treeviewet
    tree3.bind()
...
def utskrift_karstat(dato_aar_utskriftside4, dato_m_utskriftside4, dato_d_utskriftside4, tree4):
    # Binder Treeviewet
    tree4.bind()
...
def utskrifter():
    ...
    ttk.Entry(f3, textvariable=fra_aar_utskriftside3, width=5).grid(column=2, row=3, columnspan=4,
                                                                    padx=80, pady=5,
                                                                    sticky=(N, E))

    fra_m_utskriftside3 = StringVar()
    ttk.Entry(f3, textvariable=fra_m_utskriftside3, width=3).grid(column=2, row=3, columnspan=4,
                                                                  padx=45,
                                                                  pady=5, sticky=(N, E))

    fra_d_utskriftside3 = StringVar()
    ttk.Entry(f3, textvariable=fra_d_utskriftside3, width=3).grid(column=2, row=3, columnspan=4,
                                                                  padx=10, pady=5,
                                                                  sticky=(N, E))

    # til dato
    til_aar_utskriftside3 = StringVar()
    ttk.Entry(f3, textvariable=til_aar_utskriftside3, width=5).grid(column=2, row=4, columnspan=4,
                                                                    padx=80, pady=5,
                                                                    sticky=(N, E))

    til_m_utskriftside3 = StringVar()
    ttk.Entry(f3, textvariable=til_m_utskriftside3, width=3).grid(column=2, row=4, columnspan=4,
                                                                  padx=45,
                                                                  pady=5, sticky=(N, E))

    til_d_utskriftside3 = StringVar()
    ttk.Entry(f3, textvariable=til_d_utskriftside3, width=3).grid(column=2, row=4, columnspan=4,
                                                                  padx=10, pady=5,
                                                                  sticky=(N, E))
    ...
    ttk.Button(f3, text='Utfør',
               command=lambda: utskrift_eksamen_pd(fra_aar_utskriftside3, fra_m_utskriftside3, fra_d_utskriftside3,
                                                   til_aar_utskriftside3, til_m_utskriftside3,
                                                   til_d_utskriftside3, tree3)).grid(column=3, row=5,
                                                                                     columnspan=2, padx=25,
                                                                                     pady=10, sticky=E)
    ...
    ttk.Entry(f4, textvariable=emnekode_utskriftside4, width=14).grid(row=3, column=2, columnspan=2, padx=10, pady=5,
                                                                      sticky=E)

    ttk.Label(f4, text='Dato:').grid(row=4, column=2, columnspan=2, padx=140, pady=5, sticky=E)

    ttk.Entry(f4, textvariable=dato_aar_utskriftside4, width=5).grid(column=2, row=4, columnspan=2, padx=80, pady=5,
                                                                     sticky=(N, E))

    ttk.Entry(f4, textvariable=dato_m_utskriftside4, width=3).grid(column=2, row=4, columnspan=2, padx=45, pady=5,
                                                                   sticky=(N, E))

    ttk.Entry(f4, textvariable=dato_d_utskriftside4, width=3).grid(column=2, row=4, columnspan=2, padx=10, pady=5,
                                                                   sticky=(N, E))
    ...
    ttk.Button(f4, text='Utfør',
               command=lambda: utskrift_karstat(emnekode_utskriftside4, dato_aar_utskriftside4, dato_m_utskriftside4,
                                                dato_d_utskriftside4, tree4)).grid(
    ...
    ttk.Label(f5, text="En oversikt som viser studentene i et emne", font=('Calibri', '14')).grid(column=0,
                                                                                                  columnspan=3, row=0,
                                                                                                  pady=15,
                                                                                                  padx=15)
    ...
    # Lager et panewindow som skal gi informasjon til brukeren
    ttk.Label(f6, text="Utskrift av vitnemål for en student", font=('Calibri', '14')).grid(column=0, columnspan=4,
                                                                                           row=0, pady=15, padx=15)
...
def adm_kar_gui():
    ...
    ttk.Entry(f2, textvariable=dato_karakteradd, width=15).grid(row=2, column=3, padx=0, pady=5, sticky=W)
...
def eksamen_endre(emnekode_eksamenendre, til_rom_eksamenendre, fra_rom_eksamenendre, til_dato_aar_eksamenendre,
                  til_dato_m_eksamenendre, til_dato_d_eksamenendre, fra_dato_aar_eksamenendre, fra_dato_m_eksamenendre,
                  fra_dato_d_eksamenendre):
    # Lager cursor
    marker = mydb.cursor()
...
def oppmelding_eksamen(emnekode_eksamenoppmelding, dato_eksamenoppmelding, studentnr_eksamenoppmelding):
    # Oppretter cursor
    marker = mydb.cursor()

    # Henter strengene og lagrer de som variabler
    emnekode = emnekode_eksamenoppmelding.get()
    dato = dato_eksamenoppmelding.get()
...
def utskrift_opp(tree_opp, emnekode_eksamenoppmelding, dato_eksamenoppmelding, studentnr_eksamenoppmelding):
    # Binder Treeviewet
    tree_opp.bind()
    ...
    dato_oppmelding = dato_eksamenoppmelding.get()
...
def adm_eksamen_gui():
    ...
    p.grid(row=0, column=2, columnspan=1, rowspan=3, padx=10, sticky=W)
    ...
    ttk.Entry(f2, textvariable=til_rom_eksamenendre, width=7).grid(row=5, column=2, padx=5, pady=5, sticky=W)
    ...
    ttk.Entry(f2, textvariable=fra_rom_eksamenendre, width=7).grid(row=6, column=2, padx=5, pady=5, sticky=W)

    # Lager knapp som sender til databsen
    ttk.Button(f2, text='Endre eksamen',
               command=lambda: eksamen_endre(til_dato_aar_eksamenendre, til_dato_m_eksamenendre,
                                             til_dato_d_eksamenendre, til_rom_eksamenendre, fra_dato_aar_eksamenendre,
                                             fra_dato_m_eksamenendre, fra_dato_d_eksamenendre,
                                             fra_rom_eksamenendre))\
    ...
    ttk.Entry(f3, textvariable=dato_aar_eksamenoppmelding, width=5).grid(column=1, row=1, rowspan=3, padx=80, pady=35, sticky=(N, W))
    dato_m_eksamenoppmelding = StringVar()
    ttk.Entry(f3, textvariable=dato_m_eksamenoppmelding, width=3).grid(column=1, row=1, rowspan=3, padx=45, pady=35, sticky=(N, W))
    dato_d_eksamenoppmelding = StringVar()
    ttk.Entry(f3, textvariable=dato_d_eksamenoppmelding, width=3).grid(column=1, row=1, rowspan=3, padx=10, pady=35, sticky=(N, W))
...
# Strenger for eksamen oppmelding
emnekode_eksamenoppmelding = StringVar()
dato_aar_eksamenoppmelding = StringVar()
dato_m_eksamenoppmelding = StringVar()
dato_d_eksamenoppmelding = StringVar()
romnr_eksamenoppmelding = StringVar()
...
# Strenger for utskrift side 3
fra_d_utskriftside3 = StringVar()
fra_m_utskriftside3 = StringVar()
fra_aar_utskriftside3 = StringVar()
til_d_utskriftside3 = StringVar()
ttil_m_utskriftside3 = StringVar()
til_aar_utskriftside3 = StringVar()

# Strenger for utskrift side 4
