...
def adm_eksamen_gui():
    ...
    ttk.Button(f3, text='Meld opp til eksamen',
               command=lambda: oppmelding_eksamen(emne_kode_opp, dato_opp, studentnr_opp)) \
    ...
    ttk.Button(f3, text='Klikk her!',
               command=lambda: utskrift_opp(tree_opp, emne_kode_opp, dato_opp, studentnr_opp)).grid(row=1, column=3,
                                                                                                    padx=40,
                                                                                                    pady=50,
                                                                                                    sticky=(N, W))
