...
def adm_eks_gui():
    ...
    ttk.Label(adm_eks, text='Studentnr:').grid(row=5, column=0, padx=5, pady=5, sticky=W)
    ttk.Entry(adm_eks, textvariable=studentnr1, width=15).grid(row=5, column=1, padx=5, pady=5, sticky=W)
